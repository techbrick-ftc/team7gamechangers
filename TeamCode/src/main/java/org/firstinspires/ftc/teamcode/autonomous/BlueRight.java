...
public class BlueRight extends LinearOpMode implements TeleAuto {
    ...
    public void runOpMode() {
        ...
        if (slamra == null) {
            ...
            Pose2d startingPose = new Pose2d(new Translation2d(9 * 0.0254, -56 * 0.0254), Rotation2d.fromDegrees(90));
        ...
        if (opModeIsActive()) {
            ...
            auto.wobbleSync(1, "blue", activeGoal, "drop", slauto, this);
